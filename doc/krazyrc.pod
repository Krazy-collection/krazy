...
IGNORESUBS is an administrator directive used only by the krazyebn(1) program.

=item IGNOREMODS module1[,module2,...]

Do not run Krazy on the specified list of KDE modules.

IGNOREMODS is an administrator directive used only by the krazyebn(1) program.
...
krazy2(1), krazy2all(1), krazy2ebn(1), perlreftut(1)
