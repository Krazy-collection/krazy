...
rm -f "$TOP"/lib/krazy2/krazy-plugins/*/captruefalse "$TOP"/lib/krazy2/krazy-sets/*/*-captruefalse
rm -f "$TOP"/lib/krazy2/krazy-plugins/*/fixuifiles "$TOP"/lib/krazy2/krazy-sets/*/*-fixuifiles
